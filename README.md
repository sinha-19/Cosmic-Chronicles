...
[![Platform](https://img.shields.io/badge/Platform-Windows%20%7C%20Linux%20%7C%20macOS-lightgrey)](https://github.com/sinha-19/Cosmic-Chronicles)
...
### Core Gameplay
- **🌌 Infinite Universes**: Explore procedurally-generated universes with unique seeds
- **⚔️ Strategic Combat System**: Engage in turn-based battles with attack, heal, and shield mechanics
- **💪 Character Progression**: Train and power up your character to face increasingly powerful foes
- **🎲 Random Adventures**: Experience dynamically-generated adventure scenarios

### Exploration & Interaction
- **🏘️ Navigation System**: Visit villages, castles, and planets across the universe
- **👥 NPC Interactions**: Meet and converse with procedurally-generated characters
- **📚 Universe Lore**: Discover the secrets of creation through the Universe Book
- **🧙 Special Characters**: Encounter wizards, mysterious figures, and legendary bosses

### Advanced Features
- **⏰ Time Manipulation**: Use Zarathorn's Time Machine to travel through years
- **👹 Boss Summoning**: Challenge powerful bosses including the legendary Vorathar
- **💾 Save/Load System**: Multiple save slots to preserve your progress
- **🌍 Universe Switching**: Travel between different universes while maintaining your character
...
- **Issues**: [Report a bug](https://github.com/sinha-19/Cosmic-Chronicles/issues)
